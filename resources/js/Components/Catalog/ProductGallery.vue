<template>
    <div class="card product-gallery">
        <div class="main-image">
            ...
            <img :src="'/storage/' + catalogStore.productSelectedPhoto" :alt="localized(catalogStore.product.title)">
        </div>

        <!-- Slick.js Gallery -->
        <div class="gallery-slider" ref="gallerySlider">
            <div class="gallery-slide" v-for="(image, index) in catalogStore.product.gallery" :key="index">
                <div class="gallery-image" @click="catalogStore.selectProductPhoto(index)"
                    ...
                    <img :src="'/storage/' + image" :alt="localized(catalogStore.product.title) + ' - Фото ' + (index + 1)">
                </div>
            </div>
        </div>
